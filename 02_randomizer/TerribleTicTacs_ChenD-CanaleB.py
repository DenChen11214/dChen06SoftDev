import random
#to be used later when choosing a random class and student
KREWES = {
...
def randName():
    randClass = list(KREWES.keys())[random.randint(0,2)] # chooses a random class
    randStudent = KREWES[randClass][random.randint(0,len(randClass) - 1)] # chooses a random student
    return randStudent
